...
Public Class FrmMain
    ...
    Public Function AddIntoList(SubjectName As String, TaskName As String, TaskDetail As String, isInfo As Boolean, TaskProgress As Long, TaskTotal As Long, FileURL As String) As Long
        ...
        a.SubItems.AddRange({item1, item2, item3, FileURL})
        If isInfo Then
    ...
    Public Function SaveList() As String
        ...
        For i = 0 To list_Remains.Items.Count - 1
            ...
            fileurl = list_Remains.Items.Item(i).SubItems(4).Text
            ...
            Else
                ...
                progress = 0
            End If
            json.Subjects(json.SubIndex(list_Remains.Items.Item(i).SubItems(0).Text)).AddTask(taskname, isinfo, total, progress, taskdetail, fileurl)
        Next
    ...
    Private Sub Timer_Fun2_Tick(sender As Object, e As EventArgs) Handles timer_Fun2.Tick
        ...
        Try
            With list_Remains.Items.Item(List_Selected)
                txt_Detail_subject1.Text = .SubItems(1).Text
                txt_Detail1.Text = .SubItems(2).Text
